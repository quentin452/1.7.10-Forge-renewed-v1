...
⚠️ If you are blocked at Querying mod information for alot of times , relaunch the modpack ⚠️(SHOULD BE FIXED SINCE V0.98)
...
* angelica-1.0.0-beta23-fork1 to 1.0.0-beta28fork2
* LOTRModfork.v36.29 to v36.30 
* optimizationsandtweaks-V1.14.4 to V1.14.6 ????????????????????????????????
* IamacatHUDV0.7 to V0.8 
* BiggessPackTweak-V1.1 to V1.2.1 
* SimpleLabels-1.7.10-1.0-9 to 1.0-9fork1 
* NotEnoughItems-2.6.47-GTNH to 2.7.7-GTNH-pre 
* CodeChickenCore-1.3.10 to 1.4.0 
* gtnhlib-0.5.20 to 0.6.0 
* ADFix-1.0.0 to 1.0.0-without-mysteriumlib 
* TwilightForest-2.6.35 to 2.7.1
* Wawla-1.2.0-GTNH to 1.3.0-GTNH 
...
* fix fps being reduced by alot by removing (suspect : ordinary coins to sgs treasure)  ????????????????????????????????????????????????????????????????????????
* fix big lags when changing dimension between overworld and twilightforest by removing (suspect : ordinary coins to sgs treasure)  ????????????????????????????????????????????????????????????????????????

[06:58:58] [NEI-worker-thread-7/ERROR] [NotEnoughItems]: Exception filtering 1xitem.microblock@2 with com.legiblenei.nei.NEILegibleConfig@2bc518a (null)
java.util.ConcurrentModificationException
	at java.util.LinkedList$ListItr.checkForComodification(LinkedList.java:966) ~[?:1.8.0_432]
	at java.util.LinkedList$ListItr.next(LinkedList.java:888) ~[?:1.8.0_432]
	at com.legiblenei.filter.modules.OneNbt.decide(OneNbt.java:34) ~[OneNbt.class:?]
	at com.legiblenei.filter.NEIFilter.matches(NEIFilter.java:55) ~[NEIFilter.class:?]
	at com.legiblenei.filter.LegibleCore.choose(LegibleCore.java:66) ~[LegibleCore.class:?]
	at com.legiblenei.filter.LegibleCore.matches(LegibleCore.java:55) ~[LegibleCore.class:?]
	at com.legiblenei.proxy.CommonProxy.matches(CommonProxy.java:70) ~[CommonProxy.class:?]
	at com.legiblenei.nei.NEILegibleConfig.matches(NEILegibleConfig.java:39) ~[NEILegibleConfig.class:?]
	at codechicken.nei.ItemList$AllMultiItemFilter.matches(ItemList.java:131) ~[ItemList$AllMultiItemFilter.class:?]
	at java.util.stream.ReferencePipeline$2$1.accept(ReferencePipeline.java:174) [?:1.8.0_432]
	at java.util.ArrayList$ArrayListSpliterator.forEachRemaining(ArrayList.java:1384) [?:1.8.0_432]
	at java.util.stream.AbstractPipeline.copyInto(AbstractPipeline.java:482) [?:1.8.0_432]
	at java.util.stream.AbstractPipeline.wrapAndCopyInto(AbstractPipeline.java:472) [?:1.8.0_432]
	at java.util.stream.ReduceOps$ReduceTask.doLeaf(ReduceOps.java:747) [?:1.8.0_432]
	at java.util.stream.ReduceOps$ReduceTask.doLeaf(ReduceOps.java:721) [?:1.8.0_432]
	at java.util.stream.AbstractTask.compute(AbstractTask.java:327) [?:1.8.0_432]
	at java.util.concurrent.CountedCompleter.exec(CountedCompleter.java:731) [?:1.8.0_432]
	at java.util.concurrent.ForkJoinTask.doExec(ForkJoinTask.java:289) [?:1.8.0_432]
	at java.util.concurrent.ForkJoinPool$WorkQueue.execLocalTasks(ForkJoinPool.java:1040) [?:1.8.0_432]
	at java.util.concurrent.ForkJoinPool$WorkQueue.runTask(ForkJoinPool.java:1058) [?:1.8.0_432]
